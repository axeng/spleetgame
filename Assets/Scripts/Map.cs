        ...
        public static Map GetMap(string name)
        {
            switch (name)
            {
                ...
                case "poulet":
                    ...
                    bl_poulet.Add(new Block("Scile_col", new Vector3(21.13661f, 26.3f, -13.1f), new Vector3(90f, 0f, 0)));
                    bl_poulet.Add(new Block("Mur_col", new Vector3(-16.7f, 31.53f, -6f), new Vector3(0f, 90f, 0)));
                    bl_poulet.Add(new Block("Icorridor_plat_col", new Vector3(0f, 25f, 0f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Icorridor_plat_col", new Vector3(24f, 25f, 0f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Icorridor_plat_col", new Vector3(143.6f, 25f, 0f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Icorridor_plat_col", new Vector3(167.6f, 25f, 0f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Icorridor_plat_col", new Vector3(119.7f, 25f, 0f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Scile_col", new Vector3(25.85f, 26.4f, -2.8f), new Vector3(90f, 180f, 0)));
                    bl_poulet.Add(new Block("Scile_col", new Vector3(21.13661f, 36.3f, -10f), new Vector3(0f, 180f, 180)));
                    bl_poulet.Add(new Block("Scile_col", new Vector3(25.85f, 26.4f, 2.8f), new Vector3(90f, 180f, 0)));
                    bl_poulet.Add(new Block("Scile_col", new Vector3(23.3f, 21.2f, -2f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("trap_pilier_col", new Vector3(98.48444f, 27.5f, -10.72713f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("trap_pilier_col", new Vector3(98.84058f, 27.61481f, -1.3f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("trap_pilier_col", new Vector3(78.68836f, 27.5f, -8.712777f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("trap_pilier_col", new Vector3(52.88676f, 28.55f, -5.586227f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Icorridor_and_pik-plateforme", new Vector3(48.1f, 24.9f, -0.3000002f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Icorridor_and_pik-plateforme", new Vector3(72.05f, 24.9f, -0.3000002f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Icorridor_and_pik-plateforme", new Vector3(95.9f, 24.9f, -0.3000002f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("trap_pilier_col", new Vector3(136.7386f, 27.5f, -5.680916f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("trap_pilier_col", new Vector3(126.0856f, 27.5f, -2.626113f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("trap_pilier_col", new Vector3(116.3842f, 27.5f, -8.191012f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("trap_pilier_col", new Vector3(106.5616f, 27.5f, -6.080332f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Icorridor_plat_col", new Vector3(191.7f, 25f, 0f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Icorridor_plat_col", new Vector3(215.2f, 25f, 0f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Icorridor_plat_col", new Vector3(262.5f, 25f, 0f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Icorridor_plat_col", new Vector3(239f, 25f, 0f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Scile_col", new Vector3(158.94f, 21.63f, -2.2f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Scile_col", new Vector3(158.94f, 23.13f, -2.2f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("trap_pilier_col", new Vector3(161.14f, 28.5f, -7.8f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Scile_col", new Vector3(212.9f, 23.13f, -2.2f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Scile_col", new Vector3(212.9f, 21.63f, -2.2f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Scile_col", new Vector3(212.9f, 20.13f, -2.2f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Scile_col", new Vector3(215.17f, 20.13f, -9.75f), new Vector3(0f, 180f, 0)));
                    bl_poulet.Add(new Block("Scile_col", new Vector3(215.17f, 21.7f, -9.75f), new Vector3(0f, 180f, 0)));
                    bl_poulet.Add(new Block("Scile_col", new Vector3(215.17f, 23.25f, -9.75f), new Vector3(0f, 180f, 0)));
                    bl_poulet.Add(new Block("trap_pilier_col", new Vector3(213.8f, 28.61f, -5.933362f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("trap_pilier_col", new Vector3(223.7f, 28.61f, -5.933362f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Scile_col", new Vector3(246.6f, 26.59f, -14.5f), new Vector3(90f, 0f, 0)));
                    bl_poulet.Add(new Block("Scile_col", new Vector3(246.6f, 26.7f, -10.5f), new Vector3(90f, 0f, 0)));
                    bl_poulet.Add(new Block("trap_pilier_col", new Vector3(203.4226f, 28.61f, -5.933362f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Scile_col", new Vector3(158.94f, 20.13f, -2.2f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("trap_pilier_col", new Vector3(150.54f, 28.51f, -7.9f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("trap_pilier_col", new Vector3(172.6f, 28.5f, -7.8f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("DOP", new Vector3(265.3571f, 19.47f, -5.94838f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Icorridor_plat_col", new Vector3(262.61f, 13.5f, -0.0999999f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Plateforme_col", new Vector3(265.4117f, 13.33f, -4.977777f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Mur_col", new Vector3(262.73f, 18f, -5.95f), new Vector3(0f, 90f, 0)));
                    bl_poulet.Add(new Block("Icorridor_plat_col", new Vector3(286.47f, 13.5f, -0.0999999f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Mur_col", new Vector3(274.54f, 31.6f, -0.1799998f), new Vector3(0f, 180f, 0)));
                    bl_poulet.Add(new Block("Mur_col", new Vector3(274.54f, 31.6f, -12f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Mur_col", new Vector3(286.4f, 31.6f, -0.1799998f), new Vector3(0f, 180f, 0)));
                    bl_poulet.Add(new Block("Mur_col", new Vector3(286.4f, 31.6f, -12f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Mur_col", new Vector3(516.9f, 20.3f, -61.1f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Icorridor_plat_col", new Vector3(522.9f, 13.9f, -59.7f), new Vector3(0f, 90f, 0)));
                    bl_poulet.Add(new Block("Icorridor_and_pik-plateforme", new Vector3(523f, 13.8f, -35.8f), new Vector3(0f, 90f, 0)));
                    bl_poulet.Add(new Block("Lcorridor_plat_col", new Vector3(498.8f, 13.6f, 0f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("trap_pilier_col", new Vector3(472.5105f, 17f, -9.275017f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("trap_pilier_col", new Vector3(461.7889f, 17f, -3.697206f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("trap_pilier_col", new Vector3(442.7877f, 17f, -1.87019f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("trap_pilier_col", new Vector3(383.1f, 17.5f, -5.34f), new Vector3(90f, 0f, 0)));
                    bl_poulet.Add(new Block("Icorridor_plat_col", new Vector3(310.31f, 13.5f, -0.0999999f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("trap_pilier_col", new Vector3(383.1f, 17.5f, -9.64f), new Vector3(270f, 0f, 0)));
                    bl_poulet.Add(new Block("Icorridor_plat_col", new Vector3(358.2f, 13.5f, -0.0999999f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Icorridor_plat_col", new Vector3(334.3f, 13.5f, -0.0999999f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Icorridor_plat_col", new Vector3(381.4f, 13.5f, -0.0999999f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Icorridor_plat_col", new Vector3(405.3f, 13.5f, -0.0999999f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("trap_pilier_col", new Vector3(318.8f, 16.2f, -9.64f), new Vector3(270f, 0f, 0)));
                    bl_poulet.Add(new Block("trap_pilier_col", new Vector3(347.2f, 17.5f, -9.64f), new Vector3(270f, 0f, 0)));
                    bl_poulet.Add(new Block("trap_pilier_col", new Vector3(347.2f, 17.5f, -5.34f), new Vector3(90f, 0f, 0)));
                    bl_poulet.Add(new Block("Icorridor_plat_col", new Vector3(428.5f, 13.5f, -0.0999999f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Icorridor_plat_col", new Vector3(499.1f, 13.5f, -0.0999999f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Icorridor_plat_col", new Vector3(475.9f, 13.5f, -0.0999999f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("Icorridor_plat_col", new Vector3(452f, 13.5f, -0.0999999f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("trap_pilier_col", new Vector3(490.1f, 17.5f, -9.64f), new Vector3(270f, 0f, 0)));
                    bl_poulet.Add(new Block("trap_pilier_col", new Vector3(490.1f, 17.5f, -5.34f), new Vector3(90f, 0f, 0)));
                    bl_poulet.Add(new Block("trap_pilier_col", new Vector3(451.0126f, 17f, -8.379164f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("trap_pilier_col", new Vector3(435.1435f, 17f, -3.859549f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("trap_pilier_col", new Vector3(422.1265f, 17f, -9.678993f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("trap_pilier_col", new Vector3(417.7932f, 17f, -0.7200003f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("trap_pilier_col", new Vector3(406.7797f, 17f, -7.832581f), new Vector3(0f, 0f, 0)));
                    bl_poulet.Add(new Block("trap_pilier_col", new Vector3(318.8f, 16.2f, -5.34f), new Vector3(90f, 0f, 0)));
